            ...
            if Usuario.objects.filter(correo=correo).exists():
                ...
                try:
                    ...
                    if not re.match(r'^(?=.*[a-zA-ZáéíóúÁÉÍÓÚñÑ])[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+$', nombre):
                        messages.error(request, "El nombre solo puede contener letras y espacios, y debe incluir al menos una letra.")
                        return render(request, "register.html")
                    if not re.match(r'^(?=.*[a-zA-ZáéíóúÁÉÍÓÚñÑ])[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+$', apellido):
                        messages.error(request, "El apellido solo puede contener letras y espacios, y debe incluir al menos una letra.")
                        return render(request, "register.html")
